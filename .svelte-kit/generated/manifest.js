const c = [
	...
	() => import("..\\..\\src\\routes\\dashboard\\chart.svelte"),
...
export const routes = [
	...
	// src/routes/dashboard/chart.svelte
	[/^\/dashboard\/chart\/?$/, [c[0], c[3], c[5]], [c[1]]],

	// src/routes/dashboard/view/[id].svelte
	[/^\/dashboard\/view\/([^/]+?)\/?$/, [c[0], c[3], c[6]], [c[1]], (m) => ({ id: d(m[1])})],

	// src/routes/logout/index.svelte
	[/^\/logout\/?$/, [c[0], c[7], c[8]], [c[1]]],

	// src/routes/signup/index.svelte
	[/^\/signup\/?$/, [c[0], c[9], c[10]], [c[1]]],

	// src/routes/login/index.svelte
	[/^\/login\/?$/, [c[0], c[11], c[12]], [c[1]]]
];
